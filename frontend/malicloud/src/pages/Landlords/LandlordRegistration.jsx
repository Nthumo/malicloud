...
const PropertyManagerRegistration = () => {
    ...
    return (
        <>
        <Helmet>
            <title>Landlord registaration - MaliCloud</title>
        </Helmet>
        ...
        <h1 className="dark:text-white">Already have an account?</h1>
          <Link to='/login'>
            <button className="border bg-zinc-900 p-2 rounded-lg hover:bg-zinc-800 items-center w-[90px] dark:text-orange-400 text-white border-none">
                Sign in
            </button>
        </Link>
        </div>
        ...
        <div className="text-white text-center mt-12">
            <h1 className="text-xl font-bold text-orange-400">Landlord</h1>
        </div>

        <div className="relative top-14 flex justify-center text-sm pb-8">
            <Form {...form}>
                <form  onSubmit={form.handleSubmit(onSubmit)} action="submit">
                    <p className="dark:text-white mb-8 text-xl">Enter your details to continue:</p>
                    ...
                    <div className="mt-8 flex justify-center ">
                        <Button className="hover:bg-zinc-950 p-4 w-[200px] bg-black dark:text-orange-400 border">Create Account</Button>
                    </div>
                </form>
            </Form>
        </div>
        ...
        <div>
            <div className="absolute bottom-24 left-20 w-24 h-24 bg-zinc-900 transform rotate-45"></div>
        </div>
        <div>
            <div className="absolute top-48 right-20 w-24 h-24 bg-zinc-900 transform rotate-45"></div>
        </div>
        </>
