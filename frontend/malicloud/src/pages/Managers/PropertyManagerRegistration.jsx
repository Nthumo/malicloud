...
const PropertyManagerRegistration = () => {
    ...
    return (
        ...
        <div className="text-white text-center mt-12">
            <h1 className="text-xl font-bold text-orange-400">Property Manager</h1>
        </div>
            ...
            <Form {...form}>
                <form  onSubmit={form.handleSubmit(onSubmit)} action="submit">
                    ...
                    <div className="mt-8 flex justify-center ">
                        <Button className="hover:bg-zinc-800 p-4 w-[200px] bg-black dark:text-orange-400 border">Create Account</Button>
                    </div>
                </form>
            </Form>
        </div>
